pub mod animation_controller {
    ...
    impl AnimController {
        ...
        //add(): adds an animation to the list of animations
        pub fn add(&mut self, anim: Anim) {
    ...
    impl Condition {
        ...
        pub fn is_met(&self) -> bool {
            ...
            let splitStr = self.condition.split(" ").collect::<Vec<&str>>();
            //println!("split condition: {} {} {}", splitStr[0], splitStr[1], splitStr[2]);
            let field = splitStr[0];
            let comparator = splitStr[1];
            let value: f32 = splitStr[2].parse().unwrap();
            if field == "x" {
